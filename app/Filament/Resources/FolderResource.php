...
class FolderResource extends Resource
{
    ...
    public static function canCreate(): bool
    {
        ...
        return Auth::user()->role == "user"; // TODO: Change the autogenerated stub
    }

    public static function getEloquentQuery(): Builder
    {
        return Folder::query()->where('company_id',Auth::user()->currentCompany->id); // TODO: Change the autogenerated stub
    }
    ...
    public static function form(Form $form): Form
    {
        return $form
            ...
            ->schema([
                ...
                Forms\Components\Hidden::make('company_id')->default(Auth::user()->currentCompany->id)->required(),
                Forms\Components\Select::make('parent_folder_id')->hidden(empty(request()->p))->default(!empty(request()->p) ? (int) request()->p : null)->options(Folder::where('parent_folder_id',null)->get()->pluck('name','id')->toArray()),
                    ...
                    ->schema([
                        Forms\Components\Grid::make()
                         ...
                         Forms\Components\Toggle::make('is_thumbs_down')->label('Show thumb button')->default(0)->hiddenOn('create'),
                         Forms\Components\Toggle::make('is_multi_lang')
                            // ->visible(fn($record) => !empty($record->is_multi_lang) ? true : false)
                             ->columnSpan(1)
                             ->label('Turn ON/OFF Multi-language')->default(0)->hiddenOn('create'),
                                Forms\Components\Textarea::make('multi_lang_desc')
                                   // ->visible(fn($record) => !empty($record->is_multi_lang) ? true : false)
                                    ->extraAttributes(['readonly'=>'readonly'])->label(''),
                ...
                Forms\Components\Section::make('3rd Party script settings')->hiddenOn('create')
                    ->columns(2)
                    ->schema([
                        Forms\Components\Grid::make()
                            ->schema([
                                Forms\Components\FileUpload::make('script_expand_icon')->label('Script collapsable icon')->hiddenOn('create'),
                                Forms\Components\FileUpload::make('script_collapsable_icon')->label('Script expand icon')->hiddenOn('create'),
                                Forms\Components\ColorPicker::make('script_collapsable_background_color')->hiddenOn('create'),
                            ]),
                    ...
                    ->schema([
                        Forms\Components\Grid::make()
                            ->schema([
                                ...
                                Forms\Components\ColorPicker::make('custom_button_color')->label('Custom button color (optional)')->hiddenOn('create'),
                            ]),

                    ])->columns(1),
                Forms\Components\Section::make('2nd AI PROMPT TEMPLATE SETTINGS')->hiddenOn('create')
                    ->columns(4)
                    ->schema([
                        Forms\Components\Grid::make()
                            ->schema([
//                                Forms\Components\TextInput::make('test_question')->hiddenOn('create'),
                                Forms\Components\Textarea::make('test_prompt')->label('2nd AI PROMPT TEMPLATE')->hiddenOn('create'),
                            ]),
                        ...
                        Forms\Components\Grid::make()
                            ->schema([
                                ...
                                Forms\Components\Select::make('prompt_lang')->label('Prompt default language')->options(languages())
                                    ->default("English")->hiddenOn('create'),
                                Forms\Components\TextInput::make('number_of_source')
                                    ->default("1")->hiddenOn('create'),
