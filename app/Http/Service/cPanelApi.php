...
class cPanelApi {
    ...
    public function addForwarderToPipe($usermail, $pipe_path) {

        $func = "https://$this->cPanelUrl:$this->cPanelPort/execute/Email/add_forwarder?domain=$this->cPanelUrl&email=$usermail%40$this->cPanelUrl&fwdopt=pipe&pipefwd=$pipe_path";
        return $this->exe_cpanel($func);
